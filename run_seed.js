...
async function run() {
    ...
    try {
        ...
        // 12. Alert
        await client.query(`INSERT INTO alert (reading_id, alert_type_id, message, timestamp, severity) VALUES
            ...
            (15, 3, 'Wind speed 34.7 m/s at Chittagong — gale-force storm approaching.',   '2025-05-14 14:05:00+06', 'High')`);
